...
async function seed () {
  ...
  await Aircrafts.create({
    ...
    type: 'Transport',
    cost: .025,
    imageUrl: 'ttps://www.fantasyofflight.com/collection/wp-content/uploads/sstbB26Gallery271850.jpg',
  ...
  await Countries.create({
    name: 'Germany',
    GFI: 1.5,
    flagUrl: 'https://www.cheapbowlingballs.com/Assets/Balls/OnTheBall/Stock_Image/Flags_Of_The_World/German_Flag.jpg',
  })
